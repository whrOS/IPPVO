...
%     D4 = zeros(1,Tmax); D4(1) = 0.5*H4{1}(1) + sum(H4{1}(2:end));
    D1 = zeros(1,Tmax); D1(1) = sum(H1{1}(2:end));
    D2 = zeros(1,Tmax); D2(1) = sum(H2{1}(2:end));
    D3 = zeros(1,Tmax); D3(1) = sum(H3{1}(2:end));
    D4 = zeros(1,Tmax); D4(1) = sum(H4{1}(2:end));
...
%         'LineWidth', LineWidth);
    ...
    xs = min([res1(1, :) res2(1, :) res12(1, :)]);
    xe = max([res1(1, :) res2(1, :) res12(1, :)]);
    ys = min([res1(2, :) res2(2, :) res12(2, :)]);
    ye = max([res1(2, :) res2(2, :) res12(2, :)]);
    lg = legend('show');
    set(lg, 'FontSize', 14);
    xlabel('Embedding capacity (bits)');
    ylabel('Proportion of shifted pixels');
    ...
    xs = min([res1(3, :) res2(3, :) res12(3, :)]);
    xe = 1000;
    ys = min([res1(1, :) res2(1, :) res12(1, :)]);
    ye = max([res1(1, :) res2(1, :) res12(1, :)]);
    lg = legend('show');
    set(lg, 'FontSize', 14);
    xlabel('Threshold');
    ylabel('Capacity');
